<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-body">
        <table class="table table-bordered table-striped dt-responsive tablaProductos" wihth="100%">
      ...
      <form role="form" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          <div class="box-body">
            ...
            <!-- Datos para el Producto-Codigo -->
            <div class="form-group">
              <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-code"></i></span>
                <input type="text" class="form-control input-lg" name="nuevoCodigo" id="nuevoCodigo"
                  placeholder="Ingresar el Codigo" readonly required>
              </div>
            </div>

            <!-- Datos para el Producto-Descripcion -->
            <div class="form-group">
              <div class="input-group">
            ...
            <!-- Datos para el Precio de Compra -->
            ...
            <!-- Subir una Imagen -->
            <div class="form-group">
              <div class="panel">Subir una Imagen</div>
              <input type="file" id="nuevaImagen" name="nuevaImagen">
              <p class="help-block">Peso Maximo de la Foto 2MB</p>
              <img src="views/img/productos/default/default.svg" class="img-thumbnail" width="90px"
